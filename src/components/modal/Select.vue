...
export default {
    ...
    methods:{
        ...mapActions(['update_infoitemsfromtext','update_movecenter','update_selectbox','update_stext','update_sido','update_gugun','update_dong','update_bjd_code','update_infoitems']),
        modaltoggle(){
